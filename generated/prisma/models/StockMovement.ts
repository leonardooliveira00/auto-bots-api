...
export type StockMovementWhereInput = {
  ...
  movementId?: Prisma.UuidFilter<"StockMovement"> | string
  ...
  employeeId?: Prisma.UuidFilter<"StockMovement"> | string
...
export type StockMovementScalarWhereWithAggregatesInput = {
  ...
  movementId?: Prisma.UuidWithAggregatesFilter<"StockMovement"> | string
  ...
  employeeId?: Prisma.UuidWithAggregatesFilter<"StockMovement"> | string
}
...
export type StockMovementOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"movementId" | "productId" | "quantity" | "type" | "reason" | "createdAt" | "employeeId", ExtArgs["result"]["stockMovement"]>
...
export interface StockMovementDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const stockMovementWithMovementIdOnly = await prisma.stockMovement.findMany({ select: { movementId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many StockMovements and only return the `movementId`
   * const stockMovementWithMovementIdOnly = await prisma.stockMovement.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more StockMovements and only return the `movementId`
   * const stockMovementWithMovementIdOnly = await prisma.stockMovement.updateManyAndReturn({
   *   select: { movementId: true },
   *   where: {
   *     // ... provide filter here
   *   },
